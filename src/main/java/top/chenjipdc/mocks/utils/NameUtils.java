...
public class NameUtils {
    ...
    public static final String[] MING = {"一", "乙", "二", "十", "丁", "厂", "七", "卜", "人", "入", "八", "九", "几", "儿", "了", "力", "乃", "刀", "又",
    ...
    public static String random() {
        ...
        int loop = NumericUtils.nextInt(1,
                3);
        for (int i = 0; i < loop; i++) {
            ming.append(MING[NumericUtils.nextInt(MING.length)]);
        }

        return XING[NumericUtils.nextInt(XING.length)] + ming;
    }
